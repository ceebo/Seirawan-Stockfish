...
bool Position::see_ge(Move m, Value threshold) const {
  ...
  if (gating_type(m) != NO_GATE_TYPE)
  {
      ...
      // Create a copy of the piece bitboards array and put the gated
      // piece in place of the original.
      memcpy(tmpPiecesBB, byTypeBB, int(PIECE_TYPE_NB) * sizeof(Bitboard));
